...
<svelte:head>
	<title>{channel?.username || 'Channel'} - LineTube</title>
</svelte:head>
			...
			<div class="channel-header">
				...
				<div class="channel-info">
					...
					<div class="info">
						...
						<p class="stats">{videos.length} {t.videos_other}</p>
...
<style>
	...
	.videos{
		background: linear-gradient(135deg, #430d8194, #42071e94);
		margin-top: 56px;
	}
	.banner {
		height: 200px;
		background: linear-gradient(135deg, var(--accent), #1e5a8e94);
